  ...
  return (
    <div className='relative max-w-[100%]'>
        ...
        <div className='flex flex-col w-[100%] items-center'>
          ...
          <section className='relative pt-[30px] pb-[75px] min-h-[25vh] w-[100%] bg-black'>
           <div className='flex flex-col'>
            {(detail != undefined) ? (  <div className='flex justify-between select-none border-slate-500  border-2 border-double p-8 w-[60%] ml-[20%]'>
              <button type="button" autoFocus key={detail[champion].passive.image.full} name='pasive' onFocus={handel2} onClick={handel} className='active:border-2 focus:border-2'><img className='z-50' name="pasive" src={URLSp + "passive" + "/" + detail[champion].passive.image.full} alt={detail[champion].passive.image.full} /></button>
                {detail[champion].spells.map((x,i) => <>
                  <button type="button" onClick={handel} className='active:border-2 hover:-translate-y-2 focus:border-2'><img className='z-40' name={i} src={URLSp + x.image.group + "/" + x.image.full} alt={x.image.full} /></button>
                </>)}
              </div>
            )
              : null}
        ...
        <section className='relative  pb-[75px] min-h-[25vh] w-[100%] bg-white'>
